...
1. Maximum flow constraint: Limits the maximum permissible flow through the turbine to the design flow value.
...
4. Anual maintenance constraint: Annual maintenance is assumed to last for 1 week annually. This constraint limits the flow to 0 during the week of the lowest flow in one year. If a year is selected for Major maintenance, annual maintenance is not performed.
